...
describe "Viewing a list of reviews" do
  ...
  it "shows the reviews for a specific movie" do
    ...
    review1 = movie1.reviews.create!(review_attributes(comment: "Funny!", user: @user))
    review2 = movie1.reviews.create!(review_attributes(comment: "Cool!", user: @user))


    movie2 = Movie.create!(movie_attributes(title: "Superman"))
    review3 = movie2.reviews.create!(review_attributes(comment: "Stuning!", user: @user))
