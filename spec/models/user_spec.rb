...
describe "A user" do
  ...
  it "requires a password confirmation when a password is present" do
    user = User.new(password: "secret123456", password_confirmation: "")
  ...
  it "requires the password to match the password confirmation" do
    user = User.new(password: "secret123456", password_confirmation: "nomatch")
  ...
  it "requires a password and matching password confirmation when creating" do
    user = User.create!(user_attributes(password: "secret123456", password_confirmation: "secret123456"))
  ...
  it "automatically encrypts the password into the password_digest attribute" do
    user = User.new(password: "secret123456")
